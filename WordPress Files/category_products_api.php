<?php
/*
Template Name: categoryProducts
*/
class CategoryProducts extends WC_REST_Products_V1_Controller

{
    ...
    function getCategoryProductsList()
    {
        $cat_id = $_GET["id"];
...
$funcname = "getCategoryProductsList";
$category_products->$funcname();
?>